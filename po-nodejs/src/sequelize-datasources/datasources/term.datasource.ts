...
// Types
import { TermArgs } from '@/terms/dto/term.args';
import { TermRelationshipArgs } from '@/terms/dto/term-relationship.args';
import { NewTermInput } from '@/terms/dto/new-term.input';
import { NewTermMetaInput } from '@/terms/dto/new-term-meta.input';
import { NewTermRelationshipInput } from '@/terms/dto/new-term-relationship.input';
import {
  TermCreationAttributes,
  TermMetaCreationAttributes,
  TermTaxonomyCreationAttributes,
} from '@/orm-entities/interfaces';
import Term from '@/sequelize-entities/entities/terms.entity';
...
import TermRelationship from '~/sequelize-entities/entities/term-relationships.entity';

@Injectable()
export class TermDataSource extends MetaDataSource<TermMeta, NewTermMetaInput> {
   ...
   */
  async createRelationship(model: NewTermRelationshipInput): Promise<TermRelationship | null> {
    const isExists =
