  ...
  <a-card :bordered="false">
    <a-form @submit="handleSubmit" :form="form" class="form">
      ...
      >
        ...
        <a-button type="primary" @click.prevent.stop="handleSubmit"> 提交 </a-button>
      </div>
    </a-form>
  </a-card>
</template>
...
export default {
  ...
  methods: {
    ...
    getTagsList() {
      tagApi.getList().then((tags) => {
        this.dynamicTags = tags;
      });
    },
    getCategoryList() {
      categoryApi.getList().then((categories) => {
      ...
      articleApi
        ...
        .then((response) => {
          ...
          this.form = this.$form.createForm(this, {
            onFieldsChange: (_, _changedFields) => {},
            mapPropsToFields: () => {
              return {
